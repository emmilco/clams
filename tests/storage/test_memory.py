...
from clams.storage import InMemoryVectorStore
...
@pytest.fixture
async def collection(store: InMemoryVectorStore) -> str:
...
class TestInMemoryVectorStore:
    ...
    async def test_create_collection(self, store: InMemoryVectorStore) -> None:
    ...
    async def test_delete_collection(self, store: InMemoryVectorStore) -> None:
    ...
    async def test_upsert_and_get(
        self, store: InMemoryVectorStore, collection: str
    ) -> None:
    ...
    async def test_delete(self, store: InMemoryVectorStore, collection: str) -> None:
    ...
    async def test_scroll(self, store: InMemoryVectorStore, collection: str) -> None:
    ...
    async def test_count(self, store: InMemoryVectorStore, collection: str) -> None:

...
from clams.observation import ObservationCollector, ObservationPersister
...
# Tool fixtures
@pytest.fixture
def memory_tools(mock_services: ServiceContainer) -> dict[str, Any]:
    """Get memory tools with mock services."""
    return get_memory_tools(mock_services)


@pytest.fixture
def code_tools(mock_services: ServiceContainer) -> dict[str, Any]:
    """Get code tools with mock services."""
    return get_code_tools(mock_services)


@pytest.fixture
def git_tools(mock_services: ServiceContainer) -> dict[str, Any]:
    """Get git tools with mock services."""
    return get_git_tools(mock_services)
...
@pytest.fixture
def search_tools(mock_searcher: MagicMock) -> dict[str, Any]:
    """Get search tools with mock services."""
    return get_search_tools(mock_searcher)
...
def context_tools(
    ...
    return get_context_tools(mock_searcher, value_store)

...
@dataclass
class MockServices:
    """Lightweight replacement for the removed ServiceContainer.

    Holds mock service instances so tests can access them by attribute name
    (e.g. mock_services.vector_store, mock_services.semantic_embedder).
    """

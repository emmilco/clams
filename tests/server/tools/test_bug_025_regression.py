"""Regression test for BUG-025: InMemoryVectorStore should support range filter operators."""
...
@pytest.mark.asyncio
async def test_gte_filter(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_lte_filter(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_gt_filter(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_lt_filter(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_in_filter(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_combined_range_filters(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_range_filter_with_equality(populated_store: InMemoryVectorStore) -> None:
...
@pytest.mark.asyncio
async def test_simple_equality_still_works(populated_store: InMemoryVectorStore) -> None:

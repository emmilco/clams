...
from calm.context.assembler import ContextAssembler
from calm.context.models import InvalidContextTypeError
from calm.context.searcher_types import (
    CodeResult,
    CommitResult,
    ExperienceResult,
    MemoryResult,
...
class MockSearcher(Searcher):
    ...
    - calm.context.searcher_types.Searcher (ABC)
    - calm.search.searcher.Searcher (concrete implementation)

"""Tests for MockEmbeddingService implementation."""
...
class TestMockEmbedding:
    """Test suite for MockEmbeddingService service."""

    @pytest.fixture
    def mock_service(self) -> MockEmbeddingService:
        """Create a MockEmbeddingService instance for testing."""
        return MockEmbeddingService()

    def test_dimension(self, mock_service: MockEmbeddingService) -> None:
    ...
    async def test_embed_deterministic(self, mock_service: MockEmbeddingService) -> None:
    ...
    async def test_embed_normalized(self, mock_service: MockEmbeddingService) -> None:
    ...
    async def test_embed_batch_empty_list(self, mock_service: MockEmbeddingService) -> None:
        """Test that embed_batch handles empty input."""
        embeddings = await mock_service.embed_batch([])
        assert embeddings == []

    async def test_embed_batch_single_item(self, mock_service: MockEmbeddingService) -> None:
    ...
    async def test_embed_long_text(self, mock_service: MockEmbeddingService) -> None:
